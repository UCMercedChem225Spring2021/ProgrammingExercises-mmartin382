...
!
!
!       Walking through the elements to put them into Array_Input.
...
!	Array_Input.
!******************************************************************************
!    Do loops to walk through each element and put them in the correct spot for 
!    AMatOut for the lower column
        k = 1
        do j = 1,N
          do i = j,N
...
!	Array_Input.
!******************************************************************************
!    doing the same steps as above but for upper column   
        k = 1
        do j = 1,N
          do i = 1,j
           AMatOut(i,j) = ArrayIn(k)
